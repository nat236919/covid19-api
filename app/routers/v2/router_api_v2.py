...
# Refresh ADAPTER
# Refresh Integrator while transversing thorugh different routes (APIv2)
def reload_api_v2_integrator(func):
    """ Reload a model for each quest """
    @wraps(func)
    def wrapper(*args, **kwargs):
        global COVID_API_V2
        #instantiating v2_integrator
