...
# suggested code for using the cache object
from utils.caching import (api_cache, API_cache_adapter)
...
class CovidAPIv2Integrator:
    ...
    def __init__(self) -> None:
        ...
        # creates the cache
        self.cache = API_cache_adapter(api_cache)
    ...
    def get_current(self) -> List[CurrentModel]:
        ...
        self.df = self.cache.get_data_daily_reports() # updated code using the cache object
    ...
    def get_current_US(self) -> List[CurrentUSModel]:
        ...
        self.df_US = self.cache.get_data_daily_reports_us()
    ...
    def get_country(self, country_name: str) -> CountryModel:
        ...
        concerned_columns = ['Confirmed', 'Deaths', 'Recovered', 'Active']
        #self.df = get_data_daily_reports() # Get base data
        self.df = self.cache.get_data_daily_reports()
    ...
    def get_time_series(self, case: str) -> List[Any]:
        ...
        self.df_time_series = self.cache.get_data_time_series()
    ...
    def get_US_time_series(self, case: str) -> List[TimeseriesUSModel]:
        ...
        if case not in ['confirmed', 'deaths']:
            ...
            self.df_US_time_series = self.cache.get_US_time_series()
