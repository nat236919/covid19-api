...
from utils.get_data import COVIDDataForAPIv2, get_data_lookup_table
...
class CovidAPIv2Integrator:
    ...
    def get_current(self) -> List[CurrentModel]:
        ...
        self.df = COVIDDataForAPIv2.get_data_daily_reports() # Get base data
    ...
    def get_current_US(self) -> List[CurrentUSModel]:
        ...
        self.df_US = COVIDDataForAPIv2.get_data_daily_reports(US=True) # Get base data
    ...
    def get_time_series(self, case: str) -> List[Any]:
        ...
        """
        self.df_time_series = COVIDDataForAPIv2.get_data_time_series() # Get base data
    ...
    def get_US_time_series(self, case: str) -> List[TimeseriesUSModel]:
        ...
        if case not in ['confirmed', 'deaths']:
            ...
            self.df_US_time_series = COVIDDataForAPIv2.get_US_time_series() # Get base data
