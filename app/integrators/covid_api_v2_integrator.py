...
class CovidAPIv2Integrator:
    ...
    def get_current(self) -> List[CurrentModel]:
        ...
        self.df = data_fetcher.get_data_daily_reports()  # Get base data
    ...
    def get_current_US(self) -> List[CurrentUSModel]:
        ...
        self.df_US = data_fetcher.get_data_daily_reports_us()  # Get base data
    ...
    def get_country(self, country_name: str) -> CountryModel:
        ...
        country_name_from_code = data_fetcher.get_data_lookup_table().get(
    ...
    def get_time_series(self, case: str) -> List[Any]:
        ...
        """
        self.df_time_series = data_fetcher.get_data_time_series()  # Get base data
    ...
    def get_US_time_series(self, case: str) -> List[TimeseriesUSModel]:
        ...
        if case not in ['confirmed', 'deaths']:
            ...
            self.df_US_time_series = data_fetcher.get_US_time_series()  # Get base data
