...
from models.covid_api_v1_model import (ConfirmedModel, CountriesModel,
                                         ...
                                         TotalModel)
from utils.get_data import COVIDDataForAPIv1
...
class CovidAPIv1:
    ...
    def __init__(self) -> None:
        ...
        list_of_dataframes = COVIDDataForAPIv1.get_data()
        ...
        list_of_time_series = COVIDDataForAPIv1.get_data(time_series=True)
