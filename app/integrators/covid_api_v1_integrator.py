...
from models.covid_api_v1_model import (ConfirmedModel, CountriesModel,
                                         ...
                                         TotalModel)
from utils.get_data import getDataSingleton
...
class CovidAPIv1:
    ...
    def __init__(self) -> None:
        ...
        list_of_dataframes = getSingletonInstance.get_data()
        ...
        list_of_time_series = getSingletonInstance.get_data(time_series=True)
