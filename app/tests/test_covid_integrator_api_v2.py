...
def test_get_country() -> None:
    ...
    assert isinstance(result, CountryModel) is True
...
def test_get_confirmed() -> None:
    ...
    assert isinstance(result, ResponseModel) is True
    assert isinstance(result.data, ConfirmedModel) is True
...
def test_get_time_series() -> None:
    ...
    assert isinstance(result[0].Coordinates, TimeseriesCaseCoordinatesModel) is True
...
def test_get_US_time_series() -> None:
    ...
    assert isinstance(result[0].Coordinates, TimeseriesUSCoordinatesModel) is True
    assert isinstance(result[0].TimeSeries, list) is True
