...
# Creational Design Pattern, encapsulate helper functions into one class as per Singleton Pattern
class SingletonHelper:

    instance = None
    @staticmethod
    def getInstance():
        if SingletonHelper.instance == None:
            SingletonHelper()
    ...
    # Get latest data
    def helper_get_latest_data_url(self,base_url: str) -> str:
    ...
    def helper_lookup_country(self,country: str) -> str:
        """ Look up a country name from a country code """
