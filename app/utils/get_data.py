...
class GlobalData(ABC):

    def __init__(self, d: DailyReports):
        self.report = d
...
class OutsideUSData(GlobalData):

    def data(self):
        self.report.get_data_daily_reports(False)


class USData(GlobalData):

    def data(self):
        self.report.get_data_daily_reports(True)
