...
class IBuilder(metaclass=ABCMeta):
    @staticmethod
    @abstractmethod
    def build_data_lookup_table() -> None:
        pass

    @staticmethod
    @abstractmethod
    def build_data_daily_reports() -> None:
        pass

    @staticmethod
    @abstractmethod
    def build_data_time_series() -> None:
        pass

    @staticmethod
    @abstractmethod
    def build_clean_timeseries_dataframe() -> None:
        pass


class DataBuilder(IBuilder):
    ...
    # Get Lookup table
    def build_data_lookup_table(self) -> Dict[str, str]:
    ...
    def build_data_daily_reports(self, US: bool = False) -> pd.DataFrame:
    ...
    # Get the timeseries dataset from JHU CSSE
    def build_data_time_series(self, US: bool = False) -> Dict[str, pd.DataFrame]:
    ...
    # Prepare DataFrames
    def build_clean_timeseries_dataframe(self, df: pd.DataFrame, US: bool = False) -> pd.DataFrame:
...
class Director:
    ...
    def construct():
        return DataBuilder() \
            .build_data_lookup_table() \
            .build_data_daily_reports() \
            .build_data_time_series() \
            .build_clean_timeseries_dataframe()
