...
class SingletonDailyReports(object):

    __instance = None

    def __init__(self):
        if not SingletonDailyReports.__instance:
            print"There exist an instance"
        else:
    ...
    @staticmethod
    def getInstance():
        if SingletonDailyReports.__instance==None:
            SingletonDailyReports()
        return SingletonDailyReports.__instance
